  ...
  return (
    <div className="space-y-16">
      <section className="text-center max-w-3xl mx-auto px-4">
        <span className="micro-label mb-4 block">{t('roadmaps.label')}</span>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 sm:gap-12 px-4 sm:px-0">
        {roadmaps.map((roadmap, index) => (
          <article key={roadmap.id} className="group border editorial-border p-6 sm:p-8 hover:bg-ink/[0.02] transition-colors">
            ...
            <div className="space-y-4 mb-8">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <h4 className="micro-label mb-1">{t('common.forWhom')}</h4>
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <h4 className="micro-label mb-1">{t('common.prerequisites')}</h4>
            ...
            >
              {t('common.view')} {t('nav.roadmaps')} <ArrowRight className="ml-2 w-4 h-4" />
            </Link>
          </article>
        ))}
      </div>
